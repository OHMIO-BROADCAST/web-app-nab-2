---
name: OHMIO Broadcast
avatar: /static/images/logoblanco.png
occupation: Project by
company: Radio Advice
email: support@ohmiobroadcast.io
twitter: https://twitter.com/ohmiobroadcast
...
- My personal site [ohmiobroadcast.com](/)
...
- Successfully migrated our Multi-Repo app into a Monorepo, I wrote a blog about it [here](https://www.ohmiobroadcast.com/steps/how-to-merge-a-repository-into-nx) so I won't forget lol
- Successfully implemented [ArcGIS](https://www.arcgis.com/home/index.html) into our awesome app
- Created my first ever npm package, It's a React component library, my little [playground](https://playground.ohmiobroadcast.com/)
- Created this portfolio website, and [open-sourced](https://github.com/dlarroder/ohmiobroadcast) it, I didn't expect it to have any stars tbh
...
- Learned [Git](https://git-scm.com/book/en/v2/Getting-Started-About-Version-Control), [Scrum](https://www.scrum.org/resources/what-is-scrum) and [Five D's](https://www.creativerevolution.com.au/steps/the-5-ds-of-strategic-design) of strategic design
