---
title: 'Solve the Broadcast Puzzle and Claim Rewards'
date: '2023-04-11'
tags: ['Answer', 'Connect Wallet', 'Add Network and Token', 'Click Claim']
draft: false
author: 'OHMIO'
summary: 'Take a journey on these few questions then connect or create a wallet not worry if you dont have one we are going to guide you click on add network and add OHMIO Token then click on Claim to finally have your tokens.'
---
...
A [component library](https://langvad.dev/steps/what-is-a-component-library/) is basically a set of re-usable components. It could be a folder inside your project with
...
![create-playground](/static/steps/create-playground.webp)
...
![tailwind-working](/static/steps/tailwind-working.webp)
...
You can check out more components on [playground.cripgoldrroder.com](https://playground.cripgoldrroder.com/).
